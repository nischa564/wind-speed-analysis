...
A company comes to you in order to improve their wind speed prediction. Currently they use a simple ARIMA model to do their wind speed predition and reach a MAE of 3.0 knots on the given [dataset](./data/raw/wind_speed.csv) 
